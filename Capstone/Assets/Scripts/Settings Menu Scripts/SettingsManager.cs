...
public class SettingsManager : MonoBehaviour
{
    ...
    public Button recenterViewButton;           // Recentering Button
    ...
    void Start()
    {
        ...
        recenterViewButton.onClick.AddListener(RecenterView);                        // Recenter Listener for head tracking
